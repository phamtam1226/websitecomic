...
<div class="banner-top container-fluid" id="home">
    ...
    <header>
        <div class="row">
            ...
            <div class="col-md-6 logo-w3layouts top-info text-center" style="margiN-TOP:10PX">
            ...
            <div class="col-md-3 text-right mt-lg-4">
                <ul class="cart-inner-info">
                    ...
                    <li class="dropdown">
                        ...
                        <span class="fa fa-user" aria-hidden="true" style="color: rgb(35, 175, 156);"></span><a href="{{route('getLogin')}}" class="hover-nut"> Phạm Bá Tam </a>
                        @else

                        <span class="fa fa-user" aria-hidden="true" style="color: rgb(35, 175, 156);"><a id="a" class="hover-nut dropdown-toggle" href="#" data-toggle="dropdown" style="margin-left: 5px;" id="profileDropdown"><?php $infoUser = session()->get('infoUser') ?>Hi!&nbsp{{$infoUser['email']}} </a>
