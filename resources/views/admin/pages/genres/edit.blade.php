...
<div class="main-panel">
    <div class="content-wrapper">
            ...
            <div class="col-md-12" style="margin-left: 80px; padding-right:70px">
                ...
                <div class="col-12" style="padding-top:10px;">
                    <ul class="breadcrumb" style="border: none">
                        ...
                        <li>/</li>
                        <li><a href="{{ route('admin.genres.index') }}">Quản lý thể loại</a></li>
                        <li>/</li>
                        <li>Sửa thể loại</li>
                    </ul>
                </div>
        ...
        <div class="container">
            <!-- form start -->
            <form action="{{ route('admin.genres.update', $genre) }}" method="POST" enctype="multipart/form-data" onsubmit="return CheckInput();">
                {{ csrf_field() }}
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <input class="form-control" type="text" name="name" value="{{ $genre->name }}" id="name" placeholder="Tên thể loại">
                    </div>
                </div>
