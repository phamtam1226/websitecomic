          ...
          <div class="card-body">
            <table id="book" class="table" broder="1">
              ...
              <tbody>
                ...
                <tr onclick="window.location=`{{ route('admin.comment.showChapter', $comic) }}`;">
                  <td style="max-width: 180px; text-overflow: ellipsis; overflow: hidden">{{ $comic->comic_name }}</td>
                  <td style="max-width: 100px; text-overflow: ellipsis; overflow: hidden">{{ $comic->number_comments }}</td>
                </tr>
                @endforeach
              </tbody>
            </table>
